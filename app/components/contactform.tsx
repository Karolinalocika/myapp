  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-20 left-20 w-72 h-72 bg-gradient-to-br from-sky-100 to-cyan-100 rounded-full mix-blend-multiply filter blur-xl opacity-50 animate-pulse"
          style={{ animationDelay: '3s' }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse"
            ...
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-slate-600 text-lg">
                  Ilustrátorka & Grafická designérka
                </p>
              </div>
              ...
              <div className="space-y-4 pt-6">
                ...
                <div className="flex justify-center space-x-4 pt-4">
                  ...
                  >
                    <Facebook className="w-6 h-6 text-slate-700 hover:text-blue-600" />
                  </a>
                  <a
                    ...
                    className="p-2 bg-white/80 rounded-full shadow hover:bg-white transition"
                  >
                    <Instagram className="w-6 h-6 text-slate-700 hover:text-pink-500" />
                  </a>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-slate-200/50">
                <p className="text-slate-600 italic">
                  "Každý projekt je pro mě příležitost vytvořit něco, co bude mít
                  dlouhodobou hodnotu."
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-4 border border-green-100/50">
                <p className="text-green-700 text-sm">
                  <strong>✓ Připojeno:</strong> Formulář je připojen k Gmail API pro
              ...
              {formStatus === 'error' && (
                <div className="flex items-center space-x-3 p-4 bg-gradient-to-r from-red-50 to-rose-50 rounded-2xl border border-red-200/50">
                  ...
                  <p className="text-red-700 font-medium">
                    Došlo k chybě při odesílání. Zkuste to prosím znovu nebo mě
                    kontaktujte přímo.
                  </p>
                </div>
              )}
